...
var responseSchema = new Schema({
	...
	question: 		{type: mongoose.Schema.Types.ObjectId, ref: 'question', required: true},	//the question that this answer belongs to
	answer: 		{type: mongoose.Schema.Types.ObjectId, ref: 'answer', required: true},		//the answer that the user submitted
